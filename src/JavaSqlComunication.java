...
/*
    ...
    *//**
    ...
    public Integer selectLast(String column_name, String table_name ) throws Exception
    {
        if(column_name == null)
            throw new IllegalStateException("selectInt: column_name is null");
        if(table_name == null)
        ...
        Integer integer = null;
        try( Connection con = getConnection(this.databaseName+"");
             PreparedStatement posted = con.prepareStatement("SELECT " + column_name + " FROM " + table_name + " ORDER BY " + column_name + " DESC LIMIT 1");
             ResultSet temp = posted.executeQuery()
        ){
            temp.next();
            integer = temp.getInt(1);
